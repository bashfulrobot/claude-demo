...
!!! danger "⛔ STOP — do not go any further yet"
    ...
    **What to do right now:**
    ...
    1. Confirm your setup finished cleanly (no red errors in the steps above).
...
[I've been told to begin → Build a skill](tutorial/index.md){ .md-button .md-button--primary style="font-size: 1.4rem; padding: 1rem 2.5rem;" }
